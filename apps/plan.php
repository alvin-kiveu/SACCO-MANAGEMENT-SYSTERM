              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <button class="btn btn-primary edit_plan" type="button" data-id="<?php echo $row['id'] ?>"
                      data-months="<?php echo $row['months'] ?>"
                      data-interest_percentage="<?php echo $row['interest_percentage'] ?>"><i
                        class="fa fa-edit"></i></button>
                    <button class="btn btn-danger delete_plan" type="button" data-id="<?php echo $row['id'] ?>"><i
