			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label for="" class="control-label">Loan Reference N0.</label>
						<input type="hidden" name="typepayment" value="addpayment">
...
<script>
	...
	$('#manage-payment').submit(function(e) {
		...
		$.ajax({
			...
			success: function(resp) {
				if (resp == "1") {
					alert_toast("Payment added successfully.", 'success')
					setTimeout(function() {
						location.reload()
					}, 1500)
				}else{
